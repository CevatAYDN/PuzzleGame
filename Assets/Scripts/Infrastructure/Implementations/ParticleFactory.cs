...
namespace PuzzleGame.Infrastructure.Implementations
{
    ...
    public class ParticleFactory : IParticleFactory
    {
        ...
        public ParticleSystem CreateSplash()
        {
            ...
            throw new InvalidOperationException($"Splash particle prefab not found at '{SplashPrefabAddress}' or Resources/{SplashPrefabResourcePath}. Runtime fallbacks are strictly disabled.");
        }
        ...
        public ParticleSystem CreateBubble()
        {
            ...
            throw new InvalidOperationException($"Bubble particle prefab not found at '{BubblePrefabAddress}' or Resources/{BubblePrefabResourcePath}. Runtime fallbacks are strictly disabled.");
        }
