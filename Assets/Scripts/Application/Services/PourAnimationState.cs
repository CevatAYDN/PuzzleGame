...
{
    /// <summary>
    /// Per-pour animation state object. Eliminates heap-allocated lambda closures
    /// by storing all captured state in a reusable object. Pooled by AnimationService.
    /// </summary>
    internal sealed class PourAnimationState
    {
        // ── Source/Target ──────────────────────────────────────────────────────
        public IBottleView Source;
        public IBottleView Target;
        ...
        public LiquidLayer PouredLayer;
        ...
        private void OnTiltComplete()
        {
            ...
            AudioService?.PlaySfx(AudioClipId.PourLoop);
        ...
        private void OnFlowComplete()
        {
            ...
            AudioService?.PlaySfx(AudioClipId.PourEnd);
        ...
        private static void OnFlowUpdate(object target, float val)
        {
            ...
            if (s.BubblePS != null)
            {
                float liquidHeight = s.Target.Height * currentFill;
